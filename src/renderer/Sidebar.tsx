...
import { NavDrawerBody, NavItem, NavSectionHeader } from "@fluentui/react-nav-preview";
            ...
            <div style={{ flexGrow: 1 }}>
                <NavDrawerBody style={{ padding: 0 }}>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "inbox")}
                    >
                        Inbox
                    </NavItem>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "drafts")}
                    >
                        Drafts
                    </NavItem>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "sent")}
                    >
                        Sent
                    </NavItem>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "starred")}
                    >
                        Starred
                    </NavItem>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "archive")}
                    >
                        Archive
                    </NavItem>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "spam")}
                    >
                        Spam
                    </NavItem>
                    <NavItem
                        ...
                        style={navItemStyle(selectedItem === "trash")}
                    >
                        Trash
                    </NavItem>

                    <NavSectionHeader
                        style={{ marginTop: "20px", padding: "0 8px", color: theme.colorNeutralForeground1 }}
                    >
                        Employee Management
                    </NavSectionHeader>
                    <div
